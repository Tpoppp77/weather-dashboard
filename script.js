$(document).ready(function () {
    ...
    var apiKey = "8687ae869660372bd7eda0e4209f6ab5"
    var cityList = [];
    var storageList= [];
    ...
    function fiveDayForecast() {
        ...
        var fiveDay = "//api.openweathermap.org/data/2.5/forecast?q=" + city + "&units=imperial&appid=" + apiKey
        ...
        $.ajax({
            ...
            for (let i = 0; i < data.list.length; i++) {
                ...
                var iconUrl2 = "//openweathermap.org/img/w/" + iconCode2 + ".png";
